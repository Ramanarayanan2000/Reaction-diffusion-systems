...
parameters = [0.005,0.01,0.01,0,0.25,0.2,0.02,0.02,0];%the model parameters
...
grid off
title(['Stripes using Activator-inhibitor system']);
saveas(gcf,'Stripes pattern using activator inhibitor system.png')
