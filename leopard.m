...
parameters = [0.01,0.05,0,0,0.5;0.1,0.0035,0.003,0.0075,0.3;0,0.03,0.003,0.00007,22];%giraffe coat parameters
...
figure
h = heatmap(y)
mymap = [1,1,1;0,0,0];%sets a black and white output
colormap(mymap)
grid off
Ax = gca;
